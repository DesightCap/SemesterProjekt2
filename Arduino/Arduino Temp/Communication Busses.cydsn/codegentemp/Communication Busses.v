// ======================================================================
// Communication Busses.v generated from TopDesign.cysch
// 12/10/2022 at 13:35
...
module I2C_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("f761e44d-9d67-4af1-aafa-7366008028ff/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
    ...
    UART_v2_50_1 UART_TERMINAL (
        ...
        .rx_clk(Net_206),
        .rx_data(Net_207),
        .rx_interrupt(Net_208),
        .tx(Net_20),
        .tx_clk(Net_209),
        .tx_data(Net_210),
        .tx_en(Net_417),
        .tx_interrupt(Net_212));
    defparam UART_TERMINAL.Address1 = 0;
    defparam UART_TERMINAL.Address2 = 0;
    defparam UART_TERMINAL.EnIntRXInterrupt = 0;
    defparam UART_TERMINAL.EnIntTXInterrupt = 0;
    defparam UART_TERMINAL.FlowControl = 0;
    defparam UART_TERMINAL.HalfDuplexEn = 0;
    defparam UART_TERMINAL.HwTXEnSignal = 1;
    defparam UART_TERMINAL.NumDataBits = 8;
    defparam UART_TERMINAL.NumStopBits = 1;
    defparam UART_TERMINAL.ParityType = 0;
    defparam UART_TERMINAL.RXEnable = 1;
    defparam UART_TERMINAL.TXEnable = 1;
	...
	wire [0:0] tmpOE__Pin_SDL_net;
	wire [0:0] tmpFB_0__Pin_SDL_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SDL_net;
	electrical [0:0] tmpSIOVREF__Pin_SDL_net;

	cy_psoc3_pins_v1_10
		#(.id("58a3e27e-1a02-4712-8140-d9a2f0110417"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SDL
		 (.oe(tmpOE__Pin_SDL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SDL_net[0:0]}),
		  .io({Net_355}),
		  .siovref(tmpSIOVREF__Pin_SDL_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SDL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SDL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_VDD_net;
	wire [0:0] tmpFB_0__Pin_VDD_net;
	wire [0:0] tmpIO_0__Pin_VDD_net;
	wire [0:0] tmpINTERRUPT_0__Pin_VDD_net;
	electrical [0:0] tmpSIOVREF__Pin_VDD_net;

	cy_psoc3_pins_v1_10
		#(.id("604d888f-964a-4326-b239-a9552a0c0df6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_VDD
		 (.oe(tmpOE__Pin_VDD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_VDD_net[0:0]}),
		  .io({tmpIO_0__Pin_VDD_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_VDD_net),
		  .interrupt({tmpINTERRUPT_0__Pin_VDD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_VDD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
